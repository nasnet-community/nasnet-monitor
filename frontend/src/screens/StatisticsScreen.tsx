  ...
  return (
    <div className="text-right">
      ...
      <div className="mt-1 flex items-baseline justify-end gap-1">
        <span className="font-mono-nums text-[22px] font-semibold leading-none">
          {stat?.value ?? '—'}
        </span>
    ...
    <div className="flex flex-col gap-[22px]">
      <Card className="px-5 py-[18px] sm:px-6 sm:py-[22px]">
        <div className="mb-[18px] flex flex-wrap items-start justify-between gap-x-6 gap-y-3">
          ...
          <div className="ml-auto flex items-end gap-5 sm:gap-7">
      ...
      <div className="grid grid-cols-1 gap-[22px] lg:grid-cols-[1.4fr_1fr]">
        <Card className="px-5 py-[18px] sm:px-6 sm:py-[22px]">
          <div className="mb-[18px] flex flex-wrap items-start justify-between gap-x-6 gap-y-2">
        ...
        <Card className="flex flex-col items-center justify-center px-5 py-[18px] sm:px-6 sm:py-[22px]">
          ...
          <div className="mt-3 flex w-full items-center justify-center gap-2 border-t border-border pt-3">
            ...
            <span className="font-mono-nums text-[18px] font-semibold leading-none">
              {stat('Sky clarity')?.value ?? '—'}
            </span>
